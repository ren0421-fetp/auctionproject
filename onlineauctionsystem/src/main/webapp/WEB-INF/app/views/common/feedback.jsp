                    ...
                    <div class="col-lg-5">
                        <div class="auth-copy pe-lg-4 sticky-register-copy">
                            ...
                            <h1 class="auth-title mb-4">
                                Tell us how the
                                <span class="headline-accent">platform feels</span>
                            </h1>

                            <p class="auth-lead mb-4">
                                Share questions, suggestions, or issues so we can improve the experience for bidders, sellers, and admins.
                            </p>

                            <div class="auth-feature-list">
                                <div class="auth-feature-card">
                                    <div class="auth-feature-title">Questions</div>
                                    <div class="auth-feature-copy">Ask about platform behavior or confusing flows.</div>
                                </div>
                                <div class="auth-feature-card auth-feature-card-shift">
                                    <div class="auth-feature-title">Suggestions</div>
                                    <div class="auth-feature-copy">Tell us what would make the experience better.</div>
                                </div>
                                <div class="auth-feature-card">
                                    <div class="auth-feature-title">Issues</div>
                                    <div class="auth-feature-copy">Report anything that feels broken, unclear, or inconsistent.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="auth-panel auth-panel-register">
                            <div class="auth-panel-header mb-4">
                                ...
                                <p class="preview-copy mb-0">
                                    Fill in the form below and we’ll capture your message.
                                </p>
                            </div>
                            ...
                            <form:form modelAttribute="feedbackForm"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <form:errors path="contact" cssClass="auth-error" element="div" />
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <form:errors path="subject" cssClass="auth-error" element="div" />
                                    </div>

                                    <div class="col-12">
                                        <form:label path="msg" cssClass="form-label auth-label">Message</form:label>
                                        <form:textarea path="msg" rows="5" cssClass="form-control auth-input auth-textarea" />
                            ...
                            <div class="auth-footer-note mt-4">
                                Want to review announcements first?
                                <a href="${pageContext.request.contextPath}/app/news" class="auth-link">
                                    View news here
                                </a>
                            </div>
                        </div>
