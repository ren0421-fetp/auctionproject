                    ...
                    <div class="col-lg-5">
                        <div class="auth-copy pe-lg-4">
                            ...
                            <h1 class="auth-title mb-4">
                                ...
                                <span class="headline-accent">latest news</span>
                            </h1>

                            <p class="auth-lead mb-4">
                                Read announcements, platform updates, and important auction notices published by the admin team.
                            </p>

                            <div class="auth-feature-list">
                                <div class="auth-feature-card">
                                    <div class="auth-feature-title">Announcements</div>
                                    <div class="auth-feature-copy">Important notices that affect the marketplace.</div>
                                </div>
                                <div class="auth-feature-card auth-feature-card-shift">
                                    <div class="auth-feature-title">Auction Updates</div>
                                    <div class="auth-feature-copy">Changes that matter to sellers and bidders.</div>
                                </div>
                                <div class="auth-feature-card">
                                    <div class="auth-feature-title">Platform Flow</div>
                                    <div class="auth-feature-copy">Stay informed before you sign in and continue working.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="auth-panel auth-panel-register">
                            <div class="auth-panel-header mb-4">
                                ...
                                <p class="preview-copy mb-0">
                                    Recent items from the platform team.
                                </p>
                            </div>

                            <c:choose>
                                <c:when test="${empty newsList}">
                                    <div class="alert-soft-info mb-0">
                            ...
                            <div class="auth-footer-note mt-4">
                                ...
                                <a href="${pageContext.request.contextPath}/app/feedback" class="auth-link">
                                    Send feedback here
                                </a>
                            </div>
                        </div>
