...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/app/cssPath/app-layout.css">
</head>
				...
				<div class="workspace-section">
					<div class="workspace-hero mb-4">
						<div>
							...
							<p class="workspace-subtitle">Review the listing details
								carefully before placing your bid.</p>
						</div>
					...
					<div class="row g-4">
								...
								<c:choose>
									<c:when test="${not empty product.photoPath}">
										<img
											...
											alt="Product Photo" class="detail-media mb-4" />
									</c:when>
									<c:otherwise>
										<div
											class="detail-media d-flex align-items-center justify-content-center mb-4 text-muted">
						...
						<div class="col-lg-7">
							<div class="panel-card h-100">
								...
								<h2 class="panel-title">Review the numbers, then place your
									offer</h2>
								<p class="panel-copy mb-4">Your bid should be above the
									current required amount and within your remaining package
									balance.</p>
								...
								<div class="row g-3 mb-4">
									<div class="col-md-4">
										<div class="meta-item h-100">
											...
											<div class="meta-value">
												<c:out value="${product.minBidPrice}" />
											</div>
										</div>
									</div>
									<div class="col-md-4">
								...
								<div class="border-top pt-4">
									...
									<h3 class="panel-title mb-2">Submit your offer</h3>
									<p class="panel-copy mb-4">Make sure your bid amount is
										valid for the current listing conditions.</p>
									...
									<form:form modelAttribute="bidForm" method="post"
										...
										<div class="mb-3">
											...
											<form:errors path="bidPrice" cssClass="field-error"
												element="div" />
										</div>
