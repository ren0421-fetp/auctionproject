...
public class AdminUserPackageController {
	...
	public AdminUserPackageController(AdminUserPackageHelper adminUserPackageHelper,
			UserPackageFormValidator userPackageFormValidator, SessionRoleHelper sessionRoleHelper) {
	...
	public String loadUserPackages(@RequestParam(value = "userPackageId", required = false) Integer userPackageId,
	...
	public String assignPackage(@Validated @ModelAttribute("userPackageForm") UserPackageForm form,
	...
	public String approveRequest(@ModelAttribute PackagePurchaseRequestReviewForm form, Model model,
			HttpSession session) {
	...
	public String rejectRequest(@ModelAttribute PackagePurchaseRequestReviewForm form, Model model,
			HttpSession session) {
