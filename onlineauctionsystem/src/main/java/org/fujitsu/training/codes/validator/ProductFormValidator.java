...
public class ProductFormValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "endDate", "end_date.required",
        ...
        if (form.getStatus() != null
                && !form.getStatus().equals("open")
                && !form.getStatus().equals("closed")) {
            errors.rejectValue("status", "status.invalid", "Status must be open or closed.");
        }

        if (form.getStartDate() != null && !form.getStartDate().isBlank()
                && form.getEndDate() != null && !form.getEndDate().isBlank()) {
            try {
                ...
                if (!end.isAfter(start)) {
                    errors.rejectValue("endDate", "end_date.invalid",
