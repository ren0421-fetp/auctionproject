...
public interface UserDao {
	...
	@Results({ @Result(property = "username", column = "username"),
			...
			@Result(property = "address", column = "address"), @Result(property = "countryId", column = "country_id"),
			@Result(property = "stateId", column = "state_id"), @Result(property = "cityId", column = "city_id"),
			@Result(property = "email", column = "email"), @Result(property = "contactNo", column = "contact_no"),
			@Result(property = "photoPath", column = "photo_path"),
			@Result(property = "passwordHash", column = "password_hash"),
			@Result(property = "userType", column = "user_type"), @Result(property = "isLocked", column = "is_locked"),
	...
	@Update("""
			    ...
			    where username = #{username}
			      and user_type = 'seller'
			""")
	int updateSellerPassword(@Param("username") String username, @Param("passwordHash") String passwordHash);
	...
	@Results({ @Result(property = "username", column = "username"),
			...
			@Result(property = "address", column = "address"), @Result(property = "countryId", column = "country_id"),
			@Result(property = "stateId", column = "state_id"), @Result(property = "cityId", column = "city_id"),
			@Result(property = "cityName", column = "city_name"), @Result(property = "email", column = "email"),
