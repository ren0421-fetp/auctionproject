...
public class SellerProfileHelper {
	...
	public SellerProfileHelper(SellerProfileDaoImpl sellerProfileDaoImpl, FileService fileService,
	...
	public String processUpdateProfile(SellerProfileForm form, BindingResult result, Model model, String username) {
	...
	public String processChangePassword(ChangePasswordForm form, Model model, String username) {
	...
	private void populateProfilePage(Model model, SellerProfileForm profileForm,
