...
public class FeedbackFormValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "subject", "subject.required", "Subject is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "msg", "msg.required", "Message is required.");
	}
}
