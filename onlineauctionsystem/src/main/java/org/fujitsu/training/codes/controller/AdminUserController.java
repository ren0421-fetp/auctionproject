...
public class AdminUserController {
	...
	public String loadUsers(@RequestParam(value = "userType", required = false) String userType,
	...
	public String lockUser(@RequestParam("username") String username, Model model, HttpSession session) {
	...
	public String unlockUser(@RequestParam("username") String username, Model model, HttpSession session) {
