...
public class RegistrationHelper {
    private static final Logger logger = LogManager.getLogger(RegistrationHelper.class);

    private final RegistrationDaoImpl registrationDaoImpl;
    private final FileService fileService;

    public RegistrationHelper(RegistrationDaoImpl registrationDaoImpl,
    ...
    public String processSubmitForm(Model model,
        ...
        try {
            ...
            logger.error("Registration failed for {}: {}", form.getUsername(), ex.getMessage(), ex);
