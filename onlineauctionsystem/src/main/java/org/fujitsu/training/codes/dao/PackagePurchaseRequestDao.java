...
public interface PackagePurchaseRequestDao {
	...
	@Select("""
			...
			""")
	@Results({ @Result(property = "requestId", column = "request_id"),
			@Result(property = "username", column = "username"), @Result(property = "packageId", column = "package_id"),
	...
	@Update("""
			    ...
			    where request_id = #{requestId}
			      and request_status = 'PENDING'
			""")
	int reviewRequest(@Param("requestId") Integer requestId, @Param("requestStatus") String requestStatus,
			@Param("reviewedAt") LocalDateTime reviewedAt, @Param("reviewedBy") String reviewedBy,
