...
public class RegistrationFormValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "firstName", "first_name.required",
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "contactNo", "contact.required",
				"Contact number is required.");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "userType", "user_type.required",
		...
		if (form.getUserType() != null && !form.getUserType().equals("seller")
