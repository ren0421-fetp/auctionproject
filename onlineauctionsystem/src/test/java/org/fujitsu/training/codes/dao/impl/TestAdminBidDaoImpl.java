...
@Rollback(value = true)
@WebAppConfiguration
public class TestAdminBidDaoImpl {

    @Autowired
    private AdminBidDaoImpl dao;

    @Test
    public void testGetAllBidsForAdmin() {
        List<Bid> bids = dao.getAllBidsForAdmin();
        //assertNotNull(bids);
        assertTrue(!bids.isEmpty());
    }
    /*
    @Test
    public void testConfirmWinningBid() throws Exception {
        dao.confirmWinningBid(1);
    }*/
}
